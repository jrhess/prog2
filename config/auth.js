...
module.exports = {
    'googleAuth' : {
        'clientID'      : '498995464478-u7jlvjabf4cpvggaokh1stuqpg57vdv9.apps.googleusercontent.com', // TODO: put your client ID, from Google Developer Console
        'clientSecret'  : 's9AKz4v7t7heIThMc_MXeh0q', // TODO: put your client secret, from Google Developer Console
        'callbackURL'   : 'http://localhost:8080/auth/google/callback'  // TODO: you need to use your AWS IP and port, e.g., 'http://100.2.66.4:8080/auth/google/callback'
    },
